...
TEST_DATALOADER = DataLoader(TEST_DATASET, batch_size=FLAGS.batch_size*2, shuffle=False, num_workers=32, worker_init_fn=my_worker_init_fn, collate_fn=TEST_DATASET.collate_fn,sampler=test_sampler)
