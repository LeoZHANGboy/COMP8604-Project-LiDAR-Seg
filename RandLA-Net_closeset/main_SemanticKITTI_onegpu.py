...
parser.add_argument('--checkpoint_path', default='/project/RandLA-closedset/output_lv/checkpoint_11.tar', help='Model checkpoint path [default: None]')
...
def evaluate_one_epoch():
    ...
    #     s += '{:5.2f} '.format(100 * iou_tmp)
    # log_string(s)
    np.save('/root/autodl-tmp/results/close_logits.npy', pred_arr)
    np.save('/root/autodl-tmp/results/close_labels.npy', label_arr)
