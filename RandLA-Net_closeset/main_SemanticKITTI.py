...
parser.add_argument('--log_dir', default='output_lv', help='Dump dir to save model checkpoint [default: log]')
...
TRAIN_DATALOADER = DataLoader(TRAIN_DATASET, batch_size=FLAGS.batch_size, shuffle=False, num_workers=32, worker_init_fn=my_worker_init_fn, collate_fn=TRAIN_DATASET.collate_fn,sampler=train_sampler)
TEST_DATALOADER = DataLoader(TEST_DATASET, batch_size=FLAGS.batch_size, shuffle=False, num_workers=32, worker_init_fn=my_worker_init_fn, collate_fn=TEST_DATASET.collate_fn,sampler=test_sampler)
...
if torch.cuda.device_count() > 1:
    ...
    net = torch.nn.parallel.DistributedDataParallel(net, device_ids=[FLAGS.local_rank])
