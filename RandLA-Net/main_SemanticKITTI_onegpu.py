...
TEST_DATALOADER = DataLoader(TEST_DATASET, batch_size=FLAGS.batch_size*2, shuffle=True, num_workers=16, worker_init_fn=my_worker_init_fn, collate_fn=TEST_DATASET.collate_fn)
